  ...
  return (
    <div className=' w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50'>
      <div className='h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4'>
        ...
        <Image className='mt-1 w-28 object-cover' src={logo} width={150} height={150} alt='logo'/>
        </Link>
        {/* Location */}
        ...
        <div className='flex-1 h-10 hidden md:inline-flex items-center relative  justify-between'>
            <input className='h-full w-full rounded-md px-2 placeholder:text-sm text-base text-black border-[3px] outline-none border-transparent focus-visible:border-amazon_yellow' type="text" placeholder='Search Items ' />
        ...
        <p>Hii,Sign In</p>
        <p className='text-white font-bold flex items-center'> AccountList <span><BiCaretDown/></span> </p>
    </div>)}
        {/* Favotite */}
        ...
        {/* CartItems */}
        <Link href={'/cart'} className='px-2 relative flex items-center border border-transparent hover:border-white cursor-pointer duration-300 h-[70%]'>
            <Image className='w-auto h-8 object-cover' src={cartIcon} alt='cart' />
