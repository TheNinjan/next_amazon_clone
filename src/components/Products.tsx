    ...
    <div className="w-full px-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      {productData.map(
        ...
        <div className="px-4 py-3 flex flex-col gap-1">
          ...
          ))} className='className="h-10 font-medium bg-amazon_blue text-white rounded-md hover:bg-amazon_yellow hover:text-black duration-300 mt-2"'>Add to cart</button>
        </div>
    </div>
      ))}
    </div>
